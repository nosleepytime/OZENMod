...
const shots = [
  ...
  { file: 'web/dashboard.html', out: 'web-dashboard.png', width: 1600, height: 1000, fullPage: true },
  ...
  { file: 'desktop/settings.html', out: 'desktop-settings.png', width: 1440, height: 900, fullPage: true },
];
